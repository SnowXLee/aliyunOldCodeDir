...
def drawBoard(board):
  ...
  # "board" is alist of 10 strings representing(代表) the 
...
def inputPlayerLetter():
  ...
  """
  Returns a list with the player's letters as the first item,
  ...
  """
  the first element(元件、元素) in the list is the player's letter,
...
def isWinner(bo, le):
  ...
  We use bo instead(代替) of board and le instead of letter so
...
def getBoardCopy(board):
  # Make a duplicate(重复) of the board list and return it
  #the duplicat.
  dupeBoard = []
...
def chooseRandomMoveFromList(board, movesList):
  """
  Return a valid(有效) move from the passed list on the passed board.
