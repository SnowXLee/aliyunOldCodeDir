...
'Concord', 'New Jersy': 'Trenton', 'New Mexico': 'Santa Fe', 'New York': 'Albany',\
'North Carolina': 'Raleigh', 'North Dakota': 'Bismarch', 'Ohio': 'Columbus',\
'Oklahoma': 'Oklahoma City', 'Oregon': 'Salem', 'Pennsylvania': 'Harrisburg',\
'Rhode Island': 'Providence', 'South Carolina': 'Columbia', 'South Dakota':\
'Pierre', 'Vermont': 'Montpelier', 'Virginia': 'Richmond', 'Washington': 'Olympia',\
'West Virginia': 'Charleston', 'Wisconsin': 'Madison', 'Wyoming': 'Cheyenne', '48':\
'48', '49': '49', '50': '50'}
...
for quizNum in range(35):
  ...
  answerKeyFile.write('%s. %s\n' % (questionNum + 1, 'ABCD'[answerOptions\
    .index(correctAnswer)]))
quizFile.close()
answerKeyFile.close()
